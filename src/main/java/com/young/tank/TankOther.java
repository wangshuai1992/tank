...
//			oos.close();
            ...
            ObjectInputStream ois = new ObjectInputStream(TankOther.class.getClassLoader().getResourceAsStream("map/Map.tmp"));
        ...
        new AudioPlay().play("audio\\intro.wav");
    }
